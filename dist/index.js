...
var DatetimeDistanceInWords, datetimeDistanceInWords;
...
export default datetimeDistanceInWords = function(dtstart, dtend, queries) {
  return new DatetimeDistanceInWords(dtstart, dtend, queries).value();
};

DatetimeDistanceInWords = class DatetimeDistanceInWords {
